    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                <h2 className={MediumPoppins.className}>Data Privacy Policy</h2>
            </div>
            <div className={styles.body}>
                ...
                <div className={styles.first}>
                    <span className={styles.title}>1. Data We Collect
                    </span>
                    <span>1.1 Account Registration</span>
                    <span>
                    ...
                    <span>1.2 Profile Creation for Freelancer</span>
                    <span>
                    ...
                    <span>1.4 Job Application Data</span>
                    <span>
                    ...
                    <span>1.7 Device and Usage Data
                    </span>
                    <span>
                    ...
                    <span>1.9 Cookies and Tracking Technologies
                    </span>
                    <span>
                ...
                <div className={styles.first}>
                    <span className={styles.title}>2. How We Use Your Data
                    </span>
                    <span>2.1 Providing Services
                    </span>
                    <span>
                    ...
                    <span>2.3 Security and Compliance
                    </span>
                    <span>
                    ...
                    <span>2.4 Analytics and Improvements</span>
                    <span>
                ...
                <div className={styles.first}>
                    <span className={styles.title}>3. Data Sharing
                    </span>
                    <span>3.1 With Employers
                    </span>
                    <span>
                    ...
                    <span>3.4 Legal and Regulatory</span>
                    <span>
                ...
                <div className={styles.first}>
                    <span className={styles.title}>5. Data Security
                    </span>
                ...
                <div className={styles.first}>
                    <span className={styles.title}>6. Other Important Information
                    </span>
                    <span>6.1 Changes to this Policy
                    </span>
                    <span>
