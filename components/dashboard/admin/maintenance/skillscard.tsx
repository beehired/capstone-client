...
export default function SkillsCard({
    skills, createdAt, id
}: { skills: string, createdAt: any, id: any }) {
    ...
    return (
        <div className={styles.tr}>
            {toggleDelete ? <Dialog>
                <Prompt title="Do you wish to Continue" icon={<TbAlertCircleFilled size={30} />}>
                    <span className={`${PromptStyles.text} ${RegularPoppins.className}`}>Are you sure you want to delete this skill? Please confirm if you wish to proceed with the deletion of this specific skill.
                    </span>
                ...
                <Dialog>
                    <Prompt title="Edit Skills">
                        <div className={PromptStyles.body}>
                            <InputV1 name='skills' value={values.skills} type='text' placeholder={values.skills} onChange={handleChange} errors={errors.skills} touched={touched.skills} />
                        </div>
                        <div className={PromptStyles.footer}>
