      ...
      {mutation.data ? (
        <div className={styles.generatedReport}>
          ...
          <div className={styles.generateBody}>
            <table>
              ...
              <tbody>
                {mutation.data.generateApplicantByJobPostID.map(
                  ({
                    applicationID,
                    id,
                    status,
          ...
          <div className={styles.generateFooter}>
            <CSVLink
              ...
              data={mutation.data.generateApplicantByJobPostID.map(
                ({
                  applicationID,
                  id,
                  status,
        ...
        <Prompt title="Generate Report">
          ...
          <div className={PropmptStyles.footer}>
            <CancelBtn onClose={close} name="Close" />
