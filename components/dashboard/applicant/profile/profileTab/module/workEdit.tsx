...
import { CreateWorkExperienceValidationSchema, UpdateWorkExperienceValidationSchema } from '@/validations/workExperience';
import { CreateMyPortfolio, UpdateMyPorfolio } from '@/util/Mutation/portoflio.mutation';
...
export default function WorkModule({ value, setValue, portfolioID, title, description, companyName, location, startMonth, endMonth, employmentType, startYear, locationTe, endYear, skills }: any) {
    ...
    const [mutation, { loading }] = useMutation(UpdateMyPorfolio)
    ...
    const { values, errors, touched, handleSubmit, handleChange, isSubmitting, setFieldValue } = useFormik<editWork>({
        initialValues: {
            ...
            working: endMonth === null && endYear === null ? true : false,
            startMonth: startMonth,
            startYear: startYear,
            endMonth: endMonth,
            endYear: endYear,
            location: location,
            locationType: locationTe,
            skills: skill
        },
        validationSchema: UpdateWorkExperienceValidationSchema,
        onSubmit: (values, { setSubmitting }) => {
            mutation({
                ...
                onCompleted: (data) => {
                    if (data.updatePortfolio.portfolioID) {
        ...
        <div className={styles.container}>
            <div className={styles.workContainer}>
                <div className={styles.header}>
                    <h2 className={RegularPoppins.className}>Edit Work Experience</h2>
                    ...
                    {loading ? <Spinner /> :
                        <div className={styles.body}>
                            ...
                            <div className={styles.currently}>
                                <CheckboxV2 value={values.working} checked={values.working} onChange={handleChange} name='working' />
                                ...
                                <div className={styles.skillsContainer}>
                                    {
                                        SkillData?.item?.map(({ skillsID, skills }: { skillsID: never, skills: never }) => (
                                            ...
                                            >
                                                {values.skills.includes(skills) ? <TbX size={18} /> : <TbPlus size={18} />}
