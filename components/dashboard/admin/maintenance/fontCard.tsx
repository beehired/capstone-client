...
import {
  DeleteFontFamily,
  UpdateFontFamily,
} from "@/util/Mutation/font.mutation";
      ...
      {toggleDelete ? (
        <Dialog>
          ...
          >
            ...
            >
              Are you sure you want to delete this font? This action is
              permanent, and any text styled with this font will revert to the
              default. Please confirm if you wish to proceed with the deletion
              of this font.
            </span>
