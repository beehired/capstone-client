...
import {
  ...
  UpdateCompanyLogo,
} from "@/util/Mutation/company.mutation";
...
export default function Company() {
  ...
  const [companyLogo, { loading: CompanyLogoLoading }] =
    useMutation(UpdateCompanyLogo);
          ...
          <div className={styles.docs}>
            <Prompt title="Upload Company Documents">
                ...
                {fileUpload ? (
                  <div className={styles.file}>
                    ...
                    <div className={styles.details}>
                      ...
                      <span className={RegularPoppins.className}>
                        {format(
                          new Date(fileUpload.lastModified),
                          "MMMM dd, yyyy"
                        )}
                      </span>
                    </div>
              ...
              <div className={PromptStyles.footer}>
                <CancelBtn onClose={onHandleDocs} name="Cancel" />
                {fileUpload ? (
              ...
              <div className={PromptStyles.footer}>
                ...
                {values.upload ? (
                  <form onSubmit={handleSubmit}>
                    <PrimaryButton
                      loading={CompanyLogoLoading ? true : false}
                      name="Submit"
                      type="submit"
                    />
                  </form>
        ...
        <div className={styles.body}>
          ...
          <div className={styles.tbody}>
            {data?.requirements.map(
              ({ requirementsID, type, requirement, createdAt }: any) => (
                <div className={styles.tr} key={requirementsID}>
                  <div className={styles.td}>
                    <span>
                      {type.length <= 30 ? type : `${type.slice(0, 30)}...`}
                    </span>
                  </div>
                  <div className={styles.td}>
