        ...
        <div className={styles.container}>
                ...
                editStatus ? <Dialog>
                    <Prompt title='Verify Company Status'>
                        <div className={PromptStyles.header}>
                            <span>Do you want to update this company to verify? Once you confirm this company, this action cannot be undone. Verified companies gain trust and credibility on our platform, and the verification status cannot be reverted to unverified. Please confirm that all company details are accurate and up-to-date before proceeding. If you’re ready to make this change, click ‘Confirm.’ Otherwise, click ‘Cancel’ to go back.
                            </span>
                        </div>
            ...
            <div className={styles.header}>
                <div className={styles.profile}>
                    ...
                    {data?.verified ? null : <div className={styles.editBtn}>
            ...
            <div className={styles.tab}>
                {companyTab.map(({ name, value }) => (
                    ...
                    }} value={value} className={value === tab ? `${styles.active}` : ""}>
