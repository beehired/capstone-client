        ...
        <div className={styles.container}>
                ...
                <Dialog>
                    <Prompt title="Add New">
                        ...
                        <div className={PromptStyles.footer}>
                            {isSubmitting ? null :
                                <CancelBtn onClose={onHandleClose} />
                            }
            ...
            <div className={styles.body}>
                ...
                <div className={styles.tbody}>
                    {
                        isLoading ? <Spinner /> : isEmpty(data?.item) ? <NotAvailable /> : data?.item?.map(({ themeID, theme, image, createdAt }: { themeID: string, theme: string, image: string, createdAt: any }) => (
                            <ThemeCard key={themeID} themeID={themeID} theme={theme} image={image} createdAt={createdAt} />
                        ))
                    }
                </div>
            </div>
