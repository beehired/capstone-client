...
export default function About({ id }: { id: string }) {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { getAboutByProfileID } = await GraphQLRequest(
        GetMyAboutByProfileID,
        {
          profileId: id,
        }
      );
        ...
        <Dialog>
          ...
          >
            <div className={styles.header}>
              <span>
                Are you sure you want to delete this about from your profile?
                Once removed, all related information, such as your degree, will
                be permanently deleted and cannot be restored. Please confirm if
