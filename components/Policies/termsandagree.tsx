...
import styles from '@/styles/policy/terms/termsofagreement.module.scss'
import { RegularPoppins } from '../typograhy'
import { useRouter } from 'next/navigation'

export default function TermsAndCondition({ accept, onChange }: any) {
        ...
        <div className={styles.container}>
            <div className={styles.termContainer}>
                ...
                <div className={styles.header}>
                    <h2 className={RegularPoppins.className}>Terms and Condition</h2>
                </div>
                ...
                <div className={styles.body}>
                    ...
                    <div className={styles.first}>
                        <span> 3. Job Posting by Employer</span>
                        <span>3.1. Employers may post job openings on BeeHired, subject to the following conditions:</span>
                        <ul>
                            <li>
                        ...
                        <span>3.2. Job Posting Duration:</span>
                        <ul>
                            <li>
                    ...
                    <div className={styles.first}>
                        <span> 4. Freelancer Responsibilities
                        </span>
                    ...
                    <div className={styles.first}>
                        <span>9. Termination of Services
                        </span>
                    ...
                    <div className={styles.first}>
                        <span>10. Limitation of Liability
                        </span>
                    ...
                    <div className={styles.first}>
                        <span>11. Compliance with DTI Regulations
                        </span>
